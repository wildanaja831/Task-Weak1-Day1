const promise = new Promise((resolve, rejcet) => {
    ...
    xhr.open("GET", "https://api.npoint.io/675d5c355b75372c5884", true);
...
async function showAllTestimonial(){
    ...
    response.forEach(function(item){
        cardHTML += `<div class="d-flex cardt my-3">
                        <div class="card">
                            <img src="/public/images/5506218.jpg" class="card-img-top" alt="..." style="width: 400px; height: 300px; object-fit: cover;">
                            <div class="card-body">
